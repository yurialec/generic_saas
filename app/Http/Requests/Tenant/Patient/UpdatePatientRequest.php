...
class UpdatePatientRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            // Aqui usamos o $this->route('patientId') para ignorar o registro atual na checagem de unicidade:
            'cpf' => 'required|string|max:14|unique:patients,cpf,' . $this->route('patientId'),
            'email' => 'required|email|max:255|unique:patients,email,' . $this->route('patientId'),
